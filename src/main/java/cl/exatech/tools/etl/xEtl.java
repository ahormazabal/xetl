 ...
 */
public class xEtl {
  private static final Logger LOG = LoggerFactory.getLogger(xEtl.class);
   ...
   */
  public xEtl(Properties mainProperties, List<String> pipelines) throws IOException {
...
//        .collect(Collectors.toMap(Pipeline::getName, pipeline -> pipeline));
  ...
  private Pipeline loadPipeline(String filename) {
    ...
    try {
      ...
      InputStream pipeResource = xEtl.class.getResourceAsStream(path);
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      // Build etl instance.
      xEtl etl = new xEtl(properties, pipes);
